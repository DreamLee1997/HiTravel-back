  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {title: '攻略审核', icon: 'product-list'}
      },
      // {
      //   path: '',
      //   name: 'modifyUserInfo',
      //   component: () => import('@/views/tms/modifyUserInfo/index.vue'),
      //   meta: {title: '攻略审核', icon: 'order-return-reason'},
      // },
    ]
  },
  {
